...
import { createBankTransfer } from "./graphql/mutations";
const client = generateClient();
export default function BankTransferCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBankTransfer.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BankTransferCreateForm")}
      {...rest}
    >
      <TextField
        label="Uuid"
