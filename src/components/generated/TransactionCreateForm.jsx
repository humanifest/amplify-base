...
export default function TransactionCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPrivacyLevel(initialValues.privacyLevel);
    setBalanceAtCompletion(initialValues.balanceAtCompletion);
    setStatus(initialValues.status);
    setRequestResolvedAt(initialValues.requestResolvedAt);
    setErrors({});
  };
  const validations = {
    uuid: [{ type: "Required" }],
